...
const features = [
  {
    ...
    description:
      'Embark on an epic narrative woven with choice and consequence. Every decision shapes your legacy in the world of Stormroot.',
  },
  {
    icon: Map,
    title: 'Atmospheric Open Wilderness',
    description:
      'Traverse vast, untamed landscapes — from ancient storm-scarred forests to forgotten ruins swallowed by root and shadow.',
  },
  {
    icon: Sparkles,
    title: 'Unique Magic & Combat',
    description:
      'Wield a fluid, skill-based magic system born from the primordial forces of storm and earth. No two mages fight alike.',
  },
  {
    icon: Star,
    title: 'Exploration & Discovery',
    description:
      'Uncover hidden lore, secret paths, and forgotten civilisations buried beneath centuries of wilderness.',
  },
];
  ...
  return (
    <div className="min-h-screen pt-24">
          ...
          <div className="mb-6">
            <span
              ...
              style={{
                ...
                borderColor: 'rgba(212,82,42,0.4)',
      ...
      <section className="section-padding max-w-4xl mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            >
              <p>
                Stormroot Saga is an atmospheric, story-driven fantasy RPG set in a world shaped by
                forgotten magic, ancient storms, and deep wilderness. Players step into a land where
                nature itself holds memory, and where the roots of an ancient power reach into the
                present.
              </p>
              <p>
                Explore a handcrafted world where every corner holds a story, every ruin a secret.
                Build your character's legacy through meaningful choices, fluid combat, and a magic
                system unlike anything you've experienced.
              </p>
          ...
          >
            <h3
              className="font-heading text-sm tracking-widest uppercase mb-2"
            ...
            {[
              ...
              >
                <span
                  ...
                  style={{ color: 'var(--mist)', letterSpacing: '0.1em', fontSize: '0.7rem' }}
                >
                  {key}
                </span>
                <span
                  className="font-body text-sm"
                  style={{ color: 'var(--gold-light)', fontSize: '0.95rem' }}
                >
                  {val}
                </span>
              </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map(({ icon: Icon, title, description }, i) => (
              ...
              >
                ...
                <h3 className="font-heading text-base" style={{ color: 'var(--mist-light)' }}>
                  {title}
                </h3>
                <p
                  className="font-body text-sm"
                  style={{ color: 'var(--mist)', fontSize: '15px', lineHeight: 1.7 }}
                >
                  {description}
                </p>
              </div>
      ...
      <section className="section-padding max-w-6xl mx-auto px-4">
            ...
            >
              <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
                ...
                <p
                  ...
                  style={{ color: 'var(--mist-light)', letterSpacing: '0.05em' }}
                >
                  {label}
                </p>
                <p
        ...
        <p
          className="font-body text-center mt-8 text-lg italic"
          style={{ color: 'rgba(168,180,192,0.5)', fontSize: '19px' }}
        >
          Concept art and screenshots will be shared as development progresses. Follow our{' '}
          <Link href="/blog" className="underline" style={{ color: 'var(--gold-dark)' }}>
            Dev Blog
          </Link>{' '}
          for updates.
        </p>
      ...
      <section className="section-padding text-center" style={{ background: 'rgba(0,0,0,0.2)' }}>
        <div className="max-w-2xl mx-auto px-4">
          <h2
            ...
            style={{ color: 'var(--gold)', fontSize: 'clamp(1.5rem, 4vw, 2.5rem)' }}
          >
            Stay on the Journey
          </h2>
