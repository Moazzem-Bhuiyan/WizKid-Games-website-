...
export default function HomePage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/mail-list`, {
        method: 'POST',
        headers: {
      ...
      if (!res.ok) {
        ...
        const errorMessage =
          result?.errorSources?.[0]?.message || result?.message || 'Failed to subscribe';
    ...
    <div className="relative min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          ...
          >
            A UK independent game studio crafting dark, magical fantasy adventures. Our debut game
            —&nbsp;<em style={{ color: 'var(--gold-light)' }}>Stormroot Saga</em>&nbsp;— is in
            development.
          </p>

          {/* CTA buttons */}
          <div
            className="animate-fadeInUp delay-500 flex flex-col sm:flex-row gap-4 justify-center mb-16 mt-8"
            style={{ animationFillMode: 'both' }}
          >
          ...
          {/* Social links */}
          <div
            className="animate-fadeInUp delay-700 flex !pb-2 items-center justify-center gap-6 mt-10"
            style={{ animationFillMode: 'both' }}
          >
            <span
              className="font-heading text-xs tracking-widest"
              style={{ color: 'rgba(168,180,192,0.4)', letterSpacing: '0.2em', fontSize: '0.7rem' }}
            >
              FOLLOW US
            </span>
      ...
      <section className="section-padding relative overflow-hidden">
        <div
          ...
          style={{
            background:
              'radial-gradient(ellipse 60% 80% at 50% 50%, rgba(26,13,46,0.5) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4">
          ...
          >
            ...
            <em style={{ color: 'var(--gold-light)' }}>they're journeys into new worlds</em>, where
            creativity, challenge, and wonder come together."
          </blockquote>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div
            ...
            style={{
              borderColor: 'rgba(201,168,76,0.2)',
              background:
                'linear-gradient(135deg, rgba(26,13,46,0.6) 0%, rgba(8,11,20,0.8) 50%, rgba(15,18,24,0.9) 100%)',
            }}
          >
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div
                ...
                style={{
                  background:
                    'linear-gradient(135deg, rgba(26,13,46,0.9) 0%, rgba(10,15,8,0.95) 100%)',
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <h2
                  ...
                  style={{ color: 'var(--gold)', fontSize: 'clamp(1.8rem, 4vw, 2.8rem)' }}
                >
                  Stormroot Saga
                </h2>
                ...
                <p
                  ...
                  style={{ color: 'var(--mist)', fontStyle: 'italic', fontSize: '1.05rem' }}
                >
      ...
      <section className="section-padding relative">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            <span
              className="font-heading text-xs tracking-widest uppercase mb-3 block"
            ...
            <p className="font-body mb-6" style={{ color: 'var(--mist)', fontSize: '1rem' }}>
              We're thrilled to officially launch our website and introduce WizKid Games to the
              world. Stormroot Saga's development journey begins here.
            </p>
            <Link href="/blog" className="btn-ghost">
