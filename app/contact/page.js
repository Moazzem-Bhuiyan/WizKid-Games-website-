...
const socials = [
  {
    icon: Twitter,
    label: 'Twitter / X',
    href: 'https://twitter.com/wizkidgames',
    handle: '@wizkidgames',
  },
  {
    icon: Instagram,
    label: 'Instagram',
    href: 'https://instagram.com/wizkidgames',
    handle: '@wizkidgames',
  },
  {
    icon: TikTokIcon,
    label: 'TikTok',
    href: 'https://tiktok.com/@wizkidgames',
    handle: '@wizkidgames',
  },
  {
    icon: MessageCircle,
      ...
      >
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <h1
            ...
            style={{ fontSize: 'clamp(2rem, 6vw, 4rem)', color: 'var(--gold)' }}
          >
            Get in Touch
          </h1>
        ...
        <div className="grid md:grid-cols-5 gap-12">
          ...
          <div className="md:col-span-2 flex flex-col gap-10">
            ...
            <div>
              <div className="rune-divider mb-6">
                <span
                  ...
                  style={{ color: 'var(--gold-dark)', letterSpacing: '0.2em', fontSize: '1.1rem' }}
                >
                  Email
                </span>
              </div>
              <a href="mailto:office@wizkidgames.co.uk" className="flex items-center gap-3 group">
                <div
              ...
              <p
                className="font-body text-xs mt-3 ml-12"
                style={{ color: 'rgba(168,180,192,0.5)', fontSize: '0.8rem' }}
              >
              ...
              <div className="flex flex-col gap-4">
                {socials.map(({ icon: Icon, label, href, handle }) => (
                  ...
                  >
                    ...
                    <div>
                      <p
                        className="font-heading text-xs tracking-wide uppercase"
                        style={{
                          color: 'var(--mist)',
                          letterSpacing: '0.1em',
                          fontSize: '0.65rem',
                      ...
                      <p
                        className="font-body text-sm transition-colors duration-200 group-hover:text-amber-400"
                        style={{ color: 'rgba(168,180,192,0.7)', fontSize: '0.85rem' }}
                      >
                        {handle}
                      </p>
                    </div>
            ...
            >
              ...
              >
                Join the Discord to chat with the team, get exclusive updates, and connect with
                fellow adventurers.
              </p>
              <a
                href="https://discord.gg/wizkidgames"
          ...
          <div className="md:col-span-3">
            ...
            {status === 'success' ? (
              ...
              >
                ...
                <h3 className="font-heading text-xl mb-3" style={{ color: 'var(--mist-light)' }}>
                  Message Sent
                </h3>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                ...
                {status === 'error' && (
                  ...
                  >
                    <AlertCircle size={16} style={{ color: '#e05252', flexShrink: 0 }} />
                    <p className="font-body text-sm" style={{ color: '#e05252' }}>
                      {errorMsg}
                    </p>
                  </div>
                )}
                ...
                <div className="grid sm:grid-cols-2 gap-5">
                  <div>
                    <label
                      className="font-heading text-xs tracking-widest uppercase block mb-2"
                      style={{ color: 'var(--mist)', letterSpacing: '0.15em', fontSize: '0.65rem' }}
                    >
                      Name
                    </label>
                    <input
                ...
                <div className="flex items-center justify-between gap-4 flex-wrap">
                  <p
                    ...
                    style={{ color: 'rgba(168,180,192,0.4)', fontSize: '16px' }}
                  >
